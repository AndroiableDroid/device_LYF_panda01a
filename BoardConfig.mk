...
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset BOARD_RAMDISK_OFFSET --tags_offset BOARD_KERNEL_TAGS_OFFSET --dt $(DEVICE_PATH)/kernel/dt.img
BOARD_KERNEL_IMAGE_NAME := Image.gz
TARGET_KERNEL_ARCH := arm64
TARGET_KERNEL_HEADER_ARCH := arm64
TARGET_KERNEL_SOURCE := kernel/LYF/panda01a
...
# Assert
TARGET_OTA_ASSERT_DEVICE := panda01a
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 25228189184
...
# Init
TARGET_INIT_VENDOR_LIB := libinit_panda01a
TARGET_PLATFORM_DEVICE_BASE := /devices/soc.0/
TARGET_RECOVERY_DEVICE_MODULES := libinit_panda01a
